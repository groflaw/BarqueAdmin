...
export default function DatePicker({ date, name, onChange, id }) {
    ...
    <div>
      <div className="relative">
        ...
        <input
          type="text"
          readOnly
          className="cursor-pointer w-full pl-4 pr-10 py-3 leading-none rounded-lg border border-stroke focus:outline-none focus:shadow-outline text-gray-600 font-medium"
