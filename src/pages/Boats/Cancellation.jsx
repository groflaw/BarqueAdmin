...
import { submitCancellation } from "../../features/boats/boatsAction";
...
const Cancellation = () => {
  ...
  const [cancel, setCancel] = useState(curboat.cancellation);

  const handleSubmit = async () => {
    dispatch(setLoading(true));
    const result = dispatch(submitCancellation(curboat._id, cancel));
    if (result?.errors) {
              ...
              >
                ...
                >
                  ...
                  <span style={styles.des} className="w-3/4">
                    Free cancellations of reservations at any time with money
                    back.
                  </span>
                </div>
                <div
                ...
                >
                  ...
                  <span style={styles.des} className="w-3/4">
                    Cancellations of reservations are free of charge before 24
                    hours of the day the trip starts. Cancellations on the same
                    day of the reservation will be charged 50% of the cost of
                    one day's reservation
                  </span>
                </div>
                <div
                  style={styles.card}
                ...
                >
                  ...
                  <span style={styles.des} className="w-3/4">
                    Free booking cancellations within 48 hours of the day the
                    trip starts. Cancellations within 48 hours prior to the
